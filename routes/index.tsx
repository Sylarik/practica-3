    ...
    <body class="index">
      <div class="contenedor">
        <div style="text-align: center;">
          <img src="https://ov12-engine.flamingtext.com/netfu/tmp28015/coollogo_com-8171940.png" alt="tinder" style="width: 700px; height: 100%; displey: flex; align-items: center;"/>
        </div>
